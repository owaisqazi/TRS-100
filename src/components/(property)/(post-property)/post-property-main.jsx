        ...
        items: [
            {
                ...
                href: "/post-property/residential/apartment",
            },
            {
                icon: <Home className="h-8 w-8" />,
                title: "House/Villa",
                desc: "Independent residential properties",
                href: "/post-property/residential/house-villa",
            },
            {
                icon: <Building className="h-8 w-8" />,
                title: "Builder Floor",
                desc: "Single floor units in low-rise buildings",
                href: "/post-property/residential/builder-floor",
            },
            {
                icon: <MapPin className="h-8 w-8" />,
                title: "Plot",
                desc: "Land for residential construction",
                href: "/post-property/residential/plot",
            },
        ],
    },
    {
        ...
        items: [
            {
                ...
                href: "/post-property/commercial/office-space",
            },
            {
                icon: <Store className="h-8 w-8" />,
                title: "Shop",
                desc: "Retail spaces for business",
                href: "/post-property/commercial/shop",
            },
            {
                icon: <Store className="h-8 w-8" />,
                title: "Showroom",
                desc: "Display spaces for products",
                href: "/post-property/commercial/showroom",
            },
            {
                icon: <Warehouse className="h-8 w-8" />,
                title: "Warehouse",
                desc: "Storage and distribution spaces",
                href: "/post-property/commercial/warehouse",
            },
        ],
    },
]
